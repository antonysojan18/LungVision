...
const ResultsDashboard = ({ onConsultSpecialist }: ResultsDashboardProps) => {
  const { patientData, calculateRisk } = usePatient();
...
This assessment is generated by LungVision AI and should be reviewed by a qualified healthcare professional.`;
  ...
  return (
    <div className="min-h-screen relative">
      <ParticleBackground smokerMode={level === 'High' ? 'danger' : level === 'Low' ? 'safe' : 'neutral'} />
